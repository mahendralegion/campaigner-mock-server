...
const convertAjvErrors = (errors, severity, prefix) => (0, function_1.pipe)(errors, (0, NonEmptyArray_1.map)(error => {
    ...
    const errorSourceDescription = 'Request ' +
        (prefix ? `${prefix} ` : '') +
        errorPathType +
        errorPath.join('.').trim() +
        (errorPath.length > 0 ? ' ' : '');
