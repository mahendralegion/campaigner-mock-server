...
function generate(param) {
    return (0, function_1.pipe)(O.fromNullable(param.examples), pickStaticExample, O.alt(() => (0, function_1.pipe)(O.fromNullable(param.schema), O.map(improveSchema), O.chain(schema => O.fromEither((0, JSONSchema_1.generate)({}, schema))))));
}
